          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3">
            {certifications.map((cert) => (
              <article
                ...
                className="group border border-cyan-400/20 bg-black/45 p-6 transition-all duration-300 hover:-translate-y-1 hover:border-cyan-300/45 hover:shadow-[0_0_28px_rgba(56,189,248,0.12)]"
              >
                <div className="mb-4 flex items-start justify-between gap-3">
                  <Award className="h-5 w-5 shrink-0 text-cyan-300" aria-hidden />
                  <span className="border border-white/15 bg-white/5 px-2 py-1 text-[10px] font-medium uppercase tracking-wide text-zinc-300">
                    {cert.issuer}
                  </span>
                </div>
                ...
                <a
                  ...
                  className="mt-5 inline-flex items-center gap-1.5 border border-cyan-400/35 bg-cyan-400/10 px-3.5 py-2 text-xs font-semibold text-white transition-all duration-300 hover:border-cyan-300/65"
                >
                  Verify
